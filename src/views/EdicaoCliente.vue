            ...
            <div class="mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Edite as informações do cliente</p>
                    </div>
                </div>
            </div>

            <!-- Form Container -->
            <div class="bg-white rounded-xl shadow-md p-6 max-w-lg mx-auto w-full">
                <form @submit.prevent="updateClient" class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4 pt-6">
                        ...
                        <button
                            type="submit"
                            :disabled="loading"
                            class="px-6 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center space-x-2"
                        >
